            ...
            <div className="flex items-center gap-3">
              <a href="/" className="flex items-center gap-3 hover:opacity-80 transition">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Recovery Tracking</p>
                </div>
              </a>
            </div>
            <nav className="flex items-center gap-4">
              <a href="/recovery" className="btn-primary text-sm">
                <span className="material-icon" style={{ fontSize: '18px' }}>receipt_long</span>
                Recovery
              </a>
              <a href="/nmi" className="btn-secondary text-sm">
                <span className="material-icon" style={{ fontSize: '18px' }}>help_outline</span>
                NMI Tracker
              </a>
            </nav>
          </div>
